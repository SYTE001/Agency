...
import { createBrandAction, type BrandFormState } from "@/app/actions/brands";
    ...
    <form action={formAction} className="max-w-xl space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          <Input id="name" name="name" required placeholder="cth. Aksara Apparel" />
          <FieldError errors={state.fieldErrors?.name} />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="industry">Industri</Label>
          <Input id="industry" name="industry" placeholder="cth. Fashion" />
          <FieldError errors={state.fieldErrors?.industry} />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="website">Website</Label>
          <Input id="website" name="website" placeholder="https://contoh.com" />
